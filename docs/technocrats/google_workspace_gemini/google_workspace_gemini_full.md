...
Gemini Enterprise — это не просто набор AI-инструментов, а полноценная **агентная платформа**, позволяющая создавать автономных или полуавтономных помощников, которые рассуждают, планируют и выполняют действия в различных бизнес-системах.
...
Три типа grounding:
1. **Ground with Google Search** — расширение ответов актуальной информацией из интернета
2. **Ground with enterprise data** — привязка к корпоративным источникам через коннекторы
3. **Ground with uploaded sources** — привязка к конкретным загруженным документам (NotebookLM)
...
- Стандартизированный формат описания инструментов (tools)
- Безопасный доступ к БД через параметризированные SQL-запросы
- Локальное развёртывание MCP-серверов на машине пользователя (данные не покидают периметр)
- Поддержка read-only токенов для предотвращения нежелательных записей

**Agent-to-Agent Protocol (A2A)**

Открытый протокол для взаимодействия между агентами разных платформ. Позволяет интегрировать агентов, созданных на внешних платформах (Dialogflow, LangChain, CrewAI), в экосистему Gemini Enterprise.
